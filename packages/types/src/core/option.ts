import {ReportData, UserWayData} from './base';
...
export interface InitOptions {
    ...
    silentUnhandledrejection?: boolean; // 是否监控 unhandledrejection,promise中未处理的错误
    ...
    beforePushUserWay?(data: UserWayData): UserWayData; // 添加到行为列表前的 hook
