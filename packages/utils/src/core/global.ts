...
import {DaweiFront, Window} from '@dawei-front/types';
...
// 获取全部变量__daweiFront__的引用地址
export function getGlobalSupport() {
    _global.__daweiFront__ = _global.__daweiFront__ || ({} as DaweiFront);
    return _global.__daweiFront__;
}
